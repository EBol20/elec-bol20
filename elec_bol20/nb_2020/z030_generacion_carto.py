...
# %%
#abrimos los datos
data = pd.read_csv(os.path.join(ebu.DATA_PATH1,'2020','z020_geopadron_recintos_2020_ALL_DEN.csv'))
data = data.set_index('ID_RECI')
...
dfout.reset_index().to_csv(
    os.path.join(ebu.DATA_PATH1_2020,'z030_carto_xy.csv'),
    index=False
)
# %%
