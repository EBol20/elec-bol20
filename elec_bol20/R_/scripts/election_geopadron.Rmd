...
write.csv(recinto_combined_all , file = paste0(here::here(),"/../datos_1_intermedios/2020/geopadron_recintos_2020_ALL.csv"),
          row.names = FALSE, quote = TRUE)
```
\
...
write.csv(mesa_combined_all , file = paste0(here::here(),"/../datos_1_intermedios/2020/geopadron_mesas_2020_ALL.csv"),
          row.names = FALSE, quote = TRUE)
```
